...
export const Experience = () => {
  return (
    ...
    <ol className="relative border-l border-gray-400 dark:border-gray-700">
      ...
      <li className="ml-4">
        <div className="absolute w-3 h-3 bg-gray-400 rounded-full -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
        <time className="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">{currentConstant}</time>
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">{msbTitleConstant}</h3>
        <p className="text-base font-normal text-gray-500 dark:text-gray-400">{msbDescriptionConstant}</p>
      </li>
    </ol>
